...
export function pageCopy(locale: Locale) {
	...
	if (locale === 'es') {
		return {
			...
			about: {
				...
				lead: 'Colors of Design crea hogares armoniosos, modernos y atemporales en todo Estados Unidos. Desde los primeros planos hasta la instalación final, damos forma a cada proyecto como un conjunto reflexivo y personal.',
				p1: 'Con sede en Miami y presencia en Asheville, Carolina del Norte, Vero Beach y Key Biscayne, acompañamos a los clientes en planificación espacial, dibujos de diseño, carpintería a medida, acabados, mobiliario, tratamientos de ventanas e instalación llave en mano.',
				p2: 'Inspirados por la textura, la forma, la luz y el color, nuestro equipo multidisciplinario crea cada hogar alrededor de su cliente, con atención al detalle y expresión creativa.',
			...
			privacy: {
				...
				description:
					'Cómo el sitio de Colors of Design trata los borradores de consulta, los enlaces de correo y las solicitudes del sitio.',
				label: 'Privacidad',
				heading: 'Una nota sobre su privacidad.',
				intro: 'Así se trata la información cuando navega este sitio o prepara una consulta de proyecto.',
				h2inquiries: 'Consultas de proyecto',
				p1: 'El formulario de consulta prepara un borrador de correo en su navegador. El sitio no envía el formulario a un servidor ni guarda el borrador en el almacenamiento del navegador. Usted decide si abre su aplicación de correo, copia el borrador y lo envía al estudio.',
				p2: 'Cuando envía un correo, los datos de contacto y la información del proyecto que incluya se comparten con el estudio y los servicios de correo involucrados. Incluya solo lo necesario para conversar su proyecto.',
	...
	return {
		...
		about: {
			...
			lead: 'Colors of Design creates harmonious, modern, and timeless homes throughout the United States. From early plans to final installation, we shape each project as a thoughtful and personal whole.',
			p1: 'Based in Miami with a presence in Asheville, North Carolina, Vero Beach, and Key Biscayne, we guide clients through space planning, design drawings, custom cabinetry, finishes, furnishings, window treatments, and turnkey installation.',
			p2: 'Inspired by texture, shape, light, and color, our multidisciplinary team creates every home around its client with close attention to detail and creative expression.',
		...
		privacy: {
			...
			description: 'How the Colors of Design website handles project inquiry drafts, email links, and website requests.',
			label: 'Privacy',
			heading: 'A note on your privacy.',
			intro: 'Here is how information is handled when you browse this website or prepare a project inquiry.',
			h2inquiries: 'Project inquiries',
			p1: 'The inquiry form prepares an email draft in your browser. The website does not submit the form to a server or save the draft to browser storage. You choose whether to open your email app, copy the draft, and send it to the studio.',
			p2: 'When you send an email, the contact details and project information you include are shared with the studio and handled by the email services involved. Please include only what is needed to discuss your project.',
